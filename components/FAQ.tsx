...
export const FAQ: React.FC = () => {
  const faqs = [
    ...
    },
    {
      ...
      answer: "Sim! Com a consultoria do André Borba, você pode utilizar sua carta de crédito contemplada para aquisição de imóveis em países onde a legislação permite a conversão e remessa, diversificando seu patrimônio em moedas fortes."
    },
    {
      ...
      <div className="container mx-auto px-6 max-w-4xl relative z-10">
        ...
        <div className="mt-12 text-center">
          <p className="text-neutral-500 text-sm">
            Ainda tem dúvidas? <a href="https://wa.link/70toxx" className="text-[#E30613] font-bold hover:underline transition-all">Fale diretamente com André Borba</a>
          </p>
        </div>
      </div>
    </section>
