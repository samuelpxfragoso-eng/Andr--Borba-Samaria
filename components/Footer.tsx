      ...
      <div className="container mx-auto px-6">
        <div className="grid md:grid-cols-4 gap-12 mb-16">
          <div className="md:col-span-2">
            <span className="text-2xl font-extrabold tracking-tighter text-white mb-6 block">
              ANDRÉ<span className="text-[#E30613]">BORBA</span><span className="text-neutral-500 text-sm ml-1 font-medium">OFICIAL</span>
            </span>
          ...
          <div>
            ...
            <ul className="space-y-4 text-neutral-500 text-sm">
              ...
              <li>atendimento@andreborba.com.br</li>
              <li>(41) 99999-9999</li>
            </ul>
          </div>
        </div>
        ...
        <div className="pt-8 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-neutral-600 text-xs">
            © {new Date().getFullYear()} André Borba Oficial. Todos os direitos reservados.
          </p>
